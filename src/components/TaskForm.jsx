    ...
    <div className="w-full">
      {!isOpen ? (
        <button
          ...
          className="w-full flex items-center gap-3 py-3 px-5 lg:py-2.5 lg:px-4 rounded-xl border border-zinc-800/80 bg-zinc-900/30 hover:bg-zinc-900/60 text-zinc-400 hover:text-zinc-200 transition-all duration-200 active:scale-[0.99] shadow-sm"
        >
          <svg className="w-5 h-5 lg:w-4.5 lg:h-4.5 text-violet-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
        ...
        <form
          ...
          className="w-full bg-zinc-900/50 border border-zinc-800/80 rounded-xl p-5 lg:p-4 shadow-sm flex flex-col gap-4 lg:gap-3 animate-fadeIn"
        >
          <input
            ref={inputRef}
            type="text"
            ...
            className="w-full bg-transparent text-zinc-100 text-lg lg:text-base placeholder-zinc-500 border-none outline-none focus:ring-0 px-2 py-3 lg:py-2.5"
          />

          {/* Bottom row: reminder + categories + actions */}
          <div className="flex items-center justify-between border-t border-zinc-800 pt-4 gap-2">
            ...
            <div className="flex items-center gap-2.5 min-w-0">
              ...
              {/* Category pills */}
              <div className="flex gap-2 overflow-x-auto min-w-0 pr-1 py-1 scrollbar-none select-none">
                {categories.map((cat) => {
                  ...
                  return (
                    <button
                      ...
                      className="px-3 py-1 lg:px-3 lg:py-1 rounded-full text-xs lg:text-xs font-extrabold transition-all flex items-center gap-1.5 border border-zinc-800 shrink-0 select-none cursor-pointer"
                      style={{
